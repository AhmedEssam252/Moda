...
@section('title'){{ __('admin.Create') }} {{ __('admin.Admin') }} @endsection
...
<form class="form" action="{{route('StoreAdmin')}}" method="post" enctype="multipart/form-data">
    @csrf
    <h1>{{ __('admin.Create') }} {{ __('admin.Admin') }} </h1>
